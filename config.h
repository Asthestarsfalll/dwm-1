...
static const char *colors[][3]           = {          /* 颜色设置 ColFg, ColBg, ColBorder */ 
    ...
    // [SchemeSel] = { "#ebbcba", "#37474F", "#31748f" },
    // [SchemeSelGlobal] = { "#ebbcba", "#37474F", "#f6c177" },
    // [SchemeHid] = { "#dddddd", NULL, NULL },
    // [SchemeSystray] = { NULL, "#7798AA", NULL },
    // [SchemeUnderline] = { "#7799AA", NULL, NULL }, 
    // [SchemeNormTag] = { "#bbbbbb", "#333333", NULL },
    // [SchemeSelTag] = { "#eb6f92", "#31748f", "#eb6f92" },
...
static Key keys[] = {
    ...
    // { MODKEY,              XK_h,          focusstack,       {.i = +1} },               /* super tab          |  本tag内切换聚焦窗口 */
    // { MODKEY|ShiftMask,    XK_l,          focusstack,       {.i = -1} },               /* super shift tab    |  本tag内切换聚焦窗口 */
    ...
    { MODKEY|ControlMask,    XK_k,            setmfact,         {.f = -0.05} },            /* super ,            |  缩小主工作区 */
    { MODKEY|ControlMask,    XK_j,            setmfact,         {.f = +0.05} },            /* super .            |  放大主工作区 */
    ...
    { MODKEY|ShiftMask,    XK_f,            toggleallfloating,{0} },                     /* super shift t      |  开启/关闭 全部目标的float模式 */
    { MODKEY,              XK_m,            fullscreen,       {0} },                     /* super f            |  开启/关闭 全屏 */
    { MODKEY,              XK_b,            togglebar,        {0} },                     /* super shift f      |  开启/关闭 状态栏 */
    { MODKEY|ShiftMask,    XK_g,            toggleglobal,     {0} },                     /* super g            |  开启/关闭 全局 */
    { MODKEY|ShiftMask,    XK_b,            toggleborder,     {0} },                     /* super u            |  开启/关闭 边框 */
    { MODKEY,              XK_i,            incnmaster,       {.i = +1} },               /* super e            |  改变主工作区窗口数量 (1 2中切换) */

    { MODKEY,              XK_n,            focusmon,         {.i = +1} },               /* super b            |  光标移动到另一个显示器 */
    { MODKEY|ShiftMask,    XK_n,            tagmon,           {.i = +1} },               /* super shift b      |  将聚焦窗口移动到另一个显示器 */
    ...
    { MODKEY|ShiftMask,    XK_Right,        resizewin,        {.ui = H_EXPAND} },        /* super alt right    |  调整窗口 */
    ...
    { Mod4Mask,            XK_l,      spawn, SHCMD("sh ~/scripts/lockscreen.sh") },                                   /* super n          | 锁定屏幕               */
    { MODKEY|ShiftMask,    XK_a,      spawn, SHCMD("flameshot gui -c -p ~/screenshots") },             /* super shift a    | 截图                   */
