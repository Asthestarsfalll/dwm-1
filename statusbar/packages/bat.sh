...
update() {
    ...
    elif [ "$bat_text" -ge 50 ]; then bat_icon="" color="^c#eb6f92^^b#1f1d2e^";
    elif [ "$bat_text" -ge 40 ]; then bat_icon="" color="^c#eb6f92^^b#1f1d2e^";
    elif [ "$bat_text" -ge 30 ]; then bat_icon="" color="^c#eb6f92^^b#1f1d2e^";
    elif [ "$bat_text" -ge 20 ]; then bat_icon="" color="^c#eb6f92^^b#1f1d2e^";
    elif [ "$bat_text" -ge 10 ]; then bat_icon="" color="^c#eb6f92^^b#1f1d2e^";
    else bat_icon=""; fi
